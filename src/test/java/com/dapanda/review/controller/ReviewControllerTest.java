    ...
    class SaveReview {
        ...
        class Success {
            ...
            public void saveReviewTest() throws Exception {
                ...
                SaveReviewRequest request = new SaveReviewRequest(savedReviewee.getId(), productId, type, rating, comment);
                ...
                mockMvc.perform(post("/api/reviews")
                        ...
                        .andDo(document("save-review",
                                requestFields(
                                        ...
                                        fieldWithPath("type").description("리뷰 대상 상품의 타입 (필수)"),
        ...
        class Fail {
            ...
            public void validateRequiredFields() throws Exception {
                ...
                // given
                SaveReviewRequest request = new SaveReviewRequest(null, null, null, null, null);
            ...
            public void validateMemberId() throws Exception {
                ...
                SaveReviewRequest request = new SaveReviewRequest(505L, 123L, ProductType.MOBILE_DATA, 5.0f, "test");
